    ...
    return (
        <React.Fragment>
            <section className='flex items-center justify-center py-20'>
                <div style={{animation: "slideInFromLeft 1s ease-out"}} className="w-1/2 bg-gradient-to-br from-tofu-blue to-white rounded-xl shadow-2xl overflow-hidden p-8 space-y-8">
                    <div className='relative'>
                        <h2 style={{animation: "appear 2s ease-out"}} className="text-center text-4xl font-extrabold text-white font-montserrat">¡Crea una nueva receta!</h2>
                    ...
                    <form noValidate className="space-y-6" onSubmit={enviar}>
                        ...
                        <button className="w-full py-2 px-4 bg-tofu-pink border border-tofu-pink hover:bg-transparent rounded-md shadow-lg text-white font-semibold transition duration-200 uppercase font-nunito hover:text-tofu-pink" type="submit">Crear</button>
                    </form>
                </div>
            </section>
        </React.Fragment>
